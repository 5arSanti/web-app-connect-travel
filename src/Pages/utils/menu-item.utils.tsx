...
import ImageTypesScreen from "../Screens/AdminDashScreen/ImageTypesScreen";
...
const getMenuItems = (): MenuItem[] => {
  const menuItems: MenuItem[] = [
    ...
    {
      icon: <FaImages />,
      label: "Tipos de Imágenes",
      children: <ImageTypesScreen />,
      description: "Gestiona los tipos de imágenes de la plataforma.",
    },
    {
      icon: <FaNewspaper />,
      label: "Noticias",
